...
namespace JsonMaker
{
    public class JsonMakerAPDB
    {

        private JSONOAPDBbject root;
        ApStorage ap = new ApStorage();

        public JsonMakerAPDB()
        {
            root = new JSONOAPDBbject(this, "");
        }
        ...
        public ApStorage getAp()
        {
            return this.ap;
        }


        private JSONOAPDBbject find(string objectName, bool autoCreateTree, JSONOAPDBbject currentParent)
        {
            //quebra o nome em um array
            objectName = objectName.Replace("]", "").Replace("[", ".");
            string currentName = objectName;
            string childsNames = "";
            JSONOAPDBbject childOnParent;
            ...
            {
                if (autoCreateTree)
                    currentParent.setChild(currentName, new JSONOAPDBbject(this, currentParent.baseName + "." + currentName));
                else
                    return null;
            }
        ...
        private void _set(string objectName, string value)
        {
            ...
            JSONOAPDBbject temp = this.find(objectName, true, this.root);
        ...
        private void del(JSONOAPDBbject node)
        {
            ...
            var parentNodes = node.parent_Get().__getChilds();
        ...
        public void del(string objectName)
        {
            ...
            JSONOAPDBbject temp = this.find(objectName, false, this.root);
            if (temp != null)
                del(temp);
        ...
        public void set(string objectName, JsonMakerAPDB toImport)
        {
            if (objectName != "")
                objectName = objectName + ":";
        ...
        private List<string> getObjectsNames(JSONOAPDBbject currentItem = null)
        {
		...
		private List<string> getChildsNames(JSONOAPDBbject currentItem = null)
        {
            List<string> retorno = new List<string>();
